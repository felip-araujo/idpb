...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO relatorio_lider 
                               (data, celula, visitantes, convertidos, email_convertido, telefone_convertido, evento, nome_evento, criancas, coordenador_presente, supervisor_presente) 
                               VALUES (:data, :celula, :visitantes, :convertidos, :email_convertido, :telefone_convertido, :evento, :nome_evento, :criancas_presentes, :coordenador_presente, :supervisor_presente)");
...
<body>
    ...
    <form method="post">
        ...
        <label>Houve algum visitante?</label><br>
        ...
        <!-- Campo condicional para nome dos visitantes -->
        <div id="evento" style="display: none;">
            <label for="nome_visitantes">Digite o nome dos visitantes:</label>
            <input type="text" id="nome_visitantes" name="nome_visitantes"><br>
        </div><br>
