...
<body>
    ...
    <div class="main">
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col rounded" style="background-color:#999; margin-left:.5rem; margin-right:.5rem;">
                        <?php include './php/teste-notificacao.php' ?>
                    </div>
                    <div class="col text-light rounded" style="background-color:#777;" id="tables">
