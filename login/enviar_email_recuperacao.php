...
require '/opt/bitnami/htdocs/idpb/PHPMailer/src/PHPMailer.php';
require '/opt/bitnami/htdocs/idpb/PHPMailer/src/SMTP.php';
require '/opt/bitnami/htdocs/idpb/PHPMailer/src/Exception.php'; 
